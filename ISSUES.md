...
| ID | Title | Direct blockers |
|---|---|---|
| DM-010 | Specify `/me` continuity and incarnation certificates | DM-000, DM-001 |
...
| ID | Title | Direct blockers |
|---|---|---|
| DM-040 | Implement the Codex incarnation adapter | DM-025, DM-034 |
| DM-041 | Implement the external Hermes incarnation adapter | DM-025, DM-034 |
| DM-042 | Validate local Codex and Hermes `/we` continuity | DM-032–DM-041 |
