...
After this reconciliation merges, Project 9 contains 53 cards: 16 Done, 1 In
Progress, and 36 Todo. The sole in-progress card is the independent Eko Tribe
onboarding card. DM-003 and DM-016 are dependency-ready. These
counts replace the original 44-card planning snapshot.

## Completed foundation and evidence

- DM-000 through DM-004 and DM-010 through DM-015 are complete.
...
- DM-015 merged in PR 64. Source now has reviewed V0 self-claim, evidence,
  local assessment, provenance, cursor/diff/incoming/pull, quarantine-first
  intake, tombstone, and explicit promotion contracts. It does not claim that
  a signature proves ancestry or that any live corpus has been imported.
...
first awakening. DM-014 freezes species evolution and speciation, and DM-015
freezes source ancestry, provenance, and quarantine. DM-016 (tribe) is the
next dependency-ready protocol card. DM-003 remains a separate
