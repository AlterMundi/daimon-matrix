...
Tribe Bridge `main` at `636677b` records the pause handoff; its deployed/runtime
code baseline remains `b81a683` and it is still the transitional human-message
