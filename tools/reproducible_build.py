...
BUILD_INPUTS: Final = (
    ...
    Path("src/daimon_matrix/agent_chat.py"),
    Path("src/daimon_matrix/agent_chat_assets/hermes_plugin.py"),
    Path("src/daimon_matrix/agent_chat_assets/SKILL.md"),
    ...
    Path("src/daimon_matrix/execution_instruction.py"),
    Path("src/daimon_matrix/execution_store.py"),
    Path("src/daimon_matrix/hermes_review.py"),
    Path("src/daimon_matrix/hermes_review_worker.py"),
    Path("src/daimon_matrix/human_execution_frontend.py"),
    ...
    Path("src/daimon_matrix/mandatory_echo.py"),
    ...
    Path("src/daimon_matrix/operator_execution.py"),
    ...
    Path("src/daimon_matrix/relationship_store.py"),
    Path("src/daimon_matrix/review_runner.py"),
    ...
    Path("src/daimon_matrix/sources.py"),
    ...
    Path("src/daimon_matrix/tribe_conversation.py"),
