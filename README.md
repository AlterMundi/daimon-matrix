...
portable, persistent, multi-incarnation AI beings.

The project begins from the maintained
[Daimon Matrix foundation](https://hackmd.io/@nicoechaniz/daimon-matrix).
It separates a continuing being (`/me`) from its active incarnations (`/we`),
its evolutionary lineage (`/species` and `/source`), and its resource-sharing
relationships (`/tribe`).
