...
1. Merge the independently qualified Tribe successor through normal protected
   review.
2. Reconcile authoritative documents and downstream pins to the three exact
   final default-branch heads.
